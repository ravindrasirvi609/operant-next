...
const templateRows = [
    {
        ...
        code: "SOE",
        description: "Engineering faculty block.",
        parentCategory: "university",
        parentKey: "north-campus-university",
        sortOrder: 1,
        isActive: true,
    },
    {
        ...
        code: "CSE",
        description: "Department under School of Engineering.",
        parentCategory: "college",
        parentKey: "soe",
        sortOrder: 1,
        isActive: true,
    },
    {
        ...
        code: "ACADEMIC",
        description: "General academic notifications.",
        parentCategory: "",
        parentKey: "",
        sortOrder: 10,
        isActive: true,
