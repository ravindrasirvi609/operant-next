...
const navigation = [
    ...
    { href: "/admin/institutional-values-best-practices", label: "Values & Best Practices", icon: FileStack },
    { href: "/admin/student-support-governance", label: "Student Support", icon: FileStack },
    { href: "/admin/governance-leadership-iqac", label: "Leadership & IQAC", icon: FileStack },
