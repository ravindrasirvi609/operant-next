                        ...
                        <RowCard
                            ...
                            rows={selectedRecord.iqacMeetings.map((row) => (
                                <div className="rounded-lg border border-border bg-muted/50 p-4" key={row.id}>
                                    ...
                                    {row.agendaSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">Agenda: {row.agendaSummary}</p>
                                    ) : null}
                                    {row.decisionSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">Decision: {row.decisionSummary}</p>
                                    ) : null}
                                    {row.actionTakenSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">Action taken: {row.actionTakenSummary}</p>
                                    ) : null}
                                    {row.remarks ? (
                        ...
                        <RowCard
                            ...
                            rows={selectedRecord.qualityInitiatives.map((row) => (
                                <div className="rounded-lg border border-border bg-muted/50 p-4" key={row.id}>
                                    ...
                                    {row.impactSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">{row.impactSummary}</p>
                                    ) : null}
                                    {row.remarks ? (
                                        <p className="mt-2 text-sm text-muted-foreground">{row.remarks}</p>
                                    ) : null}
                            ...
                            rows={selectedRecord.complianceReviews.map((row) => (
                                <div className="rounded-lg border border-border bg-muted/50 p-4" key={row.id}>
                                    ...
                                    {row.observationsSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">Observations: {row.observationsSummary}</p>
                                    ) : null}
                                    {row.actionTakenSummary ? (
                                        <p className="mt-2 text-sm text-muted-foreground">Action taken: {row.actionTakenSummary}</p>
                                    ) : null}
