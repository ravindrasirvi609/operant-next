                            ...
                            <div className="space-y-6">
                                ...
                                >
                                    {form.iqacMeetings.map((row, index) => (
                                        <div className="space-y-4 rounded-xl border border-border bg-muted/50 p-4" key={`${row.id ?? "iqac-meeting"}-${index}`}>
                                ...
                                >
                                    {form.qualityInitiatives.map((row, index) => (
                                        <div className="space-y-4 rounded-xl border border-border bg-muted/50 p-4" key={`${row.id ?? "quality-initiative"}-${index}`}>
                                            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                                ...
                                >
                                    {form.policyCirculars.map((row, index) => (
                                        <div className="space-y-4 rounded-xl border border-border bg-muted/50 p-4" key={`${row.id ?? "policy-circular"}-${index}`}>
                                            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                                ...
                                >
                                    {form.complianceReviews.map((row, index) => (
                                        <div className="space-y-4 rounded-xl border border-border bg-muted/50 p-4" key={`${row.id ?? "compliance-review"}-${index}`}>
                                            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
