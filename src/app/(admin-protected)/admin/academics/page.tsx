...
import { listAcademicYears, listCourses, listPrograms, listSemesters } from "@/lib/admin/academics";
...
export default async function AdminAcademicsPage() {
    ...
    const [academicYears, programs, semesters, courses, institutions, departments] = await Promise.all([
        listAcademicYears(),
        listPrograms(),
        listSemesters(),
        listCourses(),
