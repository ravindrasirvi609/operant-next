...
/** Recompute the scorecard from current draft references; used by submit and update flows. */
...
/** Submit a PBAS form. Scores are written from resolveDraftState (dynamic pipeline only — no legacy path). */
